...
CREATE TABLE `geekai_files` (
  `id` int NOT NULL,
  `user_id` int NOT NULL COMMENT '用户 ID',
  `parent_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '父文件夹ID，0为根目录',
...
ALTER TABLE `geekai_files`
  ...
  ADD KEY `idx_geekai_files_parent_id` (`parent_id`);
